...
const AddPatientScreen = ({ navigation }) => {
	...
	const validateDate = (text, type) => {
		if (text == "") {
			//this should allow to delete the whole entry //new
	...
	return (
		<View style={styles.container}>
			<HeaderBar
				...
				rightComponent={
					<Button title="Save" onPress={handleSubmit} variant="ghost" size="small" disabled={loading} textStyle={styles.saveButtonText} />
				}
			/>
          ...
          <View style={styles.progressBar}>
            <View style={[styles.progressFill, { width: `${calculateProgress()}%` }]} />
				...
				<View style={styles.submitContainer}>
					...
					/>
					<Text style={styles.disclaimer}>By adding this patient, you confirm you have the necessary permissions</Text>
				</View>
			</ScrollView>
		</View>
	);
