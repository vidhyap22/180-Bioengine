...
const EditProfileScreen = ({ route, navigation }) => {
	...
	const rightComponent = (
		<TouchableOpacity onPress={handleSave} disabled={loading}>
			<Text style={[styles.saveButton, loading && styles.buttonDisabled]}>{loading ? "Saving..." : "Save"}</Text>
		</TouchableOpacity>
	);
	...
	return (
		<View style={styles.container}>
			<HeaderBar title="Edit Profile" onBack={() => navigation.goBack()} rightComponent={rightComponent} />
			...
			<ScrollView style={styles.container}>
				<View style={styles.form}>
					...
					<Text style={styles.helperText}>To change your email, please contact your administrator.</Text>
				</View>
			</ScrollView>
		</View>
	);
