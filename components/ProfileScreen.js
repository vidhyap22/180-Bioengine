...
const ProfileScreen = ({ navigation }) => {
	...
	const settingsSections = [
		...
		},
		{
			...
			icon: "person",
			items: [
				{ icon: "person-outline", text: "Edit Profile", chevron: true, onPress: () => navigation.navigate('EditProfile', {clinician : userData }) },
	...
	return (
		<View style={styles.container}>
			...
			<ScrollView style={styles.content}>
				...
				{/* Sign Out Button */}
				<Button title="Sign Out" icon="exit-outline" onPress={handleSignOut} variant="primary" style={styles.signOutButton} />
			</ScrollView>
		</View>
	);
};
